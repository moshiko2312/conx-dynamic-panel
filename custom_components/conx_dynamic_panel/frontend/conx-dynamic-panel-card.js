 ...
 */
const de = globalThis, Re = de.ShadowRoot && (de.ShadyCSS === void 0 || de.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, Me = Symbol(), Fe = /* @__PURE__ */ new WeakMap();
let lt = class {
  constructor(t, r, i) {
  ...
  get styleSheet() {
    ...
    if (Re && t === void 0) {
      ...
      i && (t = Fe.get(r)), t === void 0 && ((this.o = t = new CSSStyleSheet()).replaceSync(this.cssText), i && Fe.set(r, t));
    }
    return t;
  }
  toString() {
...
}, He = Re ? (e) => e : (e) => e instanceof CSSStyleSheet ? ((t) => {
  let r = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Lt, defineProperty: Dt, getOwnPropertyDescriptor: Nt, getOwnPropertyNames: Bt, getOwnPropertySymbols: Ft, getPrototypeOf: Ht } = Object, E = globalThis, je = E.trustedTypes, jt = je ? je.emptyScript : "", ge = E.reactiveElementPolyfillSupport, Z = (e, t) => e, he = { toAttribute(e, t) {
  switch (t) {
    case Boolean:
      e = e ? jt : null;
      break;
  ...
  return r;
} }, ze = (e, t) => !Lt(e, t), Ue = { attribute: !0, type: String, converter: he, reflect: !1, useDefault: !1, hasChanged: ze };
...
let N = class extends HTMLElement {
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(Z("properties"))) {
      const r = this.properties, i = [...Bt(r), ...Ft(r)];
  ...
  static finalizeStyles(t) {
    ...
    if (Array.isArray(t)) {
      ...
      for (const a of i) r.unshift(He(a));
  ...
  _$ET(t, r) {
    ...
    if (a !== void 0 && i.reflect === !0) {
      const n = (((o = i.converter) == null ? void 0 : o.toAttribute) !== void 0 ? i.converter : he).toAttribute(r, i.type);
  ...
  _$AK(t, r) {
    ...
    if (a !== void 0 && this._$Em !== a) {
      const s = i.getPropertyOptions(a), c = typeof s.converter == "function" ? { fromAttribute: s.converter } : ((o = s.converter) == null ? void 0 : o.fromAttribute) !== void 0 ? s.converter : he;
      this._$Em = a;
  ...
  requestUpdate(t, r, i, a = !1, o) {
    ...
    if (t !== void 0) {
      ...
      if (a === !1 && (o = this[t]), i ?? (i = s.getPropertyOptions(t)), !((i.hasChanged ?? ze)(o, r) || i.useDefault && i.reflect && o === ((n = this._$Ej) == null ? void 0 : n.get(t)) && !this.hasAttribute(s._$Eu(t, i)))) return;
      this.C(t, r, i);
    }
...
N.elementStyles = [], N.shadowRootOptions = { mode: "open" }, N[Z("elementProperties")] = /* @__PURE__ */ new Map(), N[Z("finalized")] = /* @__PURE__ */ new Map(), ge == null || ge({ ReactiveElement: N }), (E.reactiveElementVersions ?? (E.reactiveElementVersions = [])).push("2.1.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Q = globalThis, Ye = (e) => e, ue = Q.trustedTypes, We = ue ? ue.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, pt = "$lit$", S = `lit$${Math.random().toFixed(9).slice(2)}$`, ht = "?" + S, Ut = `<${ht}>`, T = document, re = () => T.createComment(""), ie = (e) => e === null || typeof e != "object" && typeof e != "function", Te = Array.isArray, Yt = (e) => Te(e) || typeof (e == null ? void 0 : e[Symbol.iterator]) == "function", be = `[ 	
\f\r]`, J = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Ge = /-->/g, Ie = />/g, R = RegExp(`>|${be}(?:([^\\s"'>=/]+)(${be}*=${be}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Je = /'/g, Xe = /"/g, ut = /^(?:script|style|textarea|title)$/i, Wt = (e) => (t, ...r) => ({ _$litType$: e, strings: t, values: r }), l = Wt(1), W = Symbol.for("lit-noChange"), p = Symbol.for("lit-nothing"), qe = /* @__PURE__ */ new WeakMap(), M = T.createTreeWalker(T, 129);
function _t(e, t) {
...
const Gt = (e, t) => {
  ...
  let a, o = t === 2 ? "<svg>" : t === 3 ? "<math>" : "", n = J;
  for (let s = 0; s < r; s++) {
    const c = e[s];
    let d, h, u = -1, g = 0;
    for (; g < c.length && (n.lastIndex = g, h = n.exec(c), h !== null); ) g = n.lastIndex, n === J ? h[1] === "!--" ? n = Ge : h[1] !== void 0 ? n = Ie : h[2] !== void 0 ? (ut.test(h[2]) && (a = RegExp("</" + h[2], "g")), n = R) : h[3] !== void 0 && (n = R) : n === R ? h[0] === ">" ? (n = a ?? J, u = -1) : h[1] === void 0 ? u = -2 : (u = n.lastIndex - h[2].length, d = h[1], n = h[3] === void 0 ? R : h[3] === '"' ? Xe : Je) : n === Xe || n === Je ? n = R : n === Ge || n === Ie ? n = J : (n = R, a = void 0);
    const b = n === R && e[s + 1].startsWith("/>") ? " " : "";
    o += n === J ? c + Ut : u >= 0 ? (i.push(d), c.slice(0, u) + pt + c.slice(u) + S + b) : c + S + (u === -2 ? s : b);
  }
  return [_t(e, o + (e[r] || "<?>") + (t === 2 ? "</svg>" : t === 3 ? "</math>" : "")), i];
};
class ae {
  constructor({ strings: t, _$litType$: r }, i) {
    ...
    this.parts = [];
    let o = 0, n = 0;
    const s = t.length - 1, c = this.parts, [d, h] = Gt(t, r);
    if (this.el = ae.createElement(d, i), M.currentNode = this.el.content, r === 2 || r === 3) {
      const u = this.el.content.firstChild;
      u.replaceWith(...u.childNodes);
    }
    for (; (a = M.nextNode()) !== null && c.length < s; ) {
      if (a.nodeType === 1) {
        if (a.hasAttributes()) for (const u of a.getAttributeNames()) if (u.endsWith(pt)) {
          const g = h[n++], b = a.getAttribute(u).split(S), y = /([.?@])?(.*)/.exec(g);
          c.push({ type: 1, index: o, name: y[2], strings: b, ctor: y[1] === "." ? Jt : y[1] === "?" ? Xt : y[1] === "@" ? qt : me }), a.removeAttribute(u);
        } else u.startsWith(S) && (c.push({ type: 6, index: o }), a.removeAttribute(u));
        if (ut.test(a.tagName)) {
          const u = a.textContent.split(S), g = u.length - 1;
          if (g > 0) {
            a.textContent = ue ? ue.emptyScript : "";
            for (let b = 0; b < g; b++) a.append(u[b], re()), M.nextNode(), c.push({ type: 2, index: ++o });
            a.append(u[g], re());
          }
        }
        ...
        let u = -1;
        for (; (u = a.data.indexOf(S, u + 1)) !== -1; ) c.push({ type: 7, index: o }), u += S.length - 1;
      }
      o++;
    }
  }
...
function G(e, t, r = e, i) {
  ...
  const o = ie(t) ? void 0 : t._$litDirective$;
  return (a == null ? void 0 : a.constructor) !== o && ((s = a == null ? void 0 : a._$AO) == null || s.call(a, !1), o === void 0 ? a = void 0 : (a = new o(e), a._$AT(e, r, i)), i !== void 0 ? (r._$Co ?? (r._$Co = []))[i] = a : r._$Cl = a), a !== void 0 && (t = G(e, a._$AS(e, t.values), a, i)), t;
}
class It {
  constructor(t, r) {
  ...
  u(t) {
    const { el: { content: r }, parts: i } = this._$AD, a = ((t == null ? void 0 : t.creationScope) ?? T).importNode(r, !0);
    M.currentNode = a;
    let o = M.nextNode(), n = 0, s = 0, c = i[0];
    for (; c !== void 0; ) {
      if (n === c.index) {
        let d;
        c.type === 2 ? d = new se(o, o.nextSibling, this, t) : c.type === 1 ? d = new c.ctor(o, c.name, c.strings, this, t) : c.type === 6 && (d = new Vt(o, this, t)), this._$AV.push(d), c = i[++s];
      }
      n !== (c == null ? void 0 : c.index) && (o = M.nextNode(), n++);
    }
    return M.currentNode = T, a;
  }
  p(t) {
    let r = 0;
...
class se {
  ...
  _$AI(t, r = this) {
    t = G(this, t, r), ie(t) ? t === p || t == null || t === "" ? (this._$AH !== p && this._$AR(), this._$AH = p) : t !== this._$AH && t !== W && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : Yt(t) ? this.k(t) : this._(t);
  }
  O(t) {
  ...
  _(t) {
    this._$AH !== p && ie(this._$AH) ? this._$AA.nextSibling.data = t : this.T(T.createTextNode(t)), this._$AH = t;
  }
  $(t) {
    var o;
    const { values: r, _$litType$: i } = t, a = typeof i == "number" ? this._$AC(t) : (i.el === void 0 && (i.el = ae.createElement(_t(i.h, i.h[0]), this.options)), i);
    if (((o = this._$AH) == null ? void 0 : o._$AD) === a) this._$AH.p(r);
    else {
      const n = new It(a, this), s = n.u(this.options);
      n.p(r), this.T(s), this._$AH = n;
    }
  }
  _$AC(t) {
    let r = qe.get(t.strings);
    return r === void 0 && qe.set(t.strings, r = new ae(t)), r;
  }
  k(t) {
    Te(this._$AH) || (this._$AH = [], this._$AR());
    const r = this._$AH;
    let i, a = 0;
    for (const o of t) a === r.length ? r.push(i = new se(this.O(re()), this.O(re()), this, this.options)) : i = r[a], i._$AI(o), a++;
    a < r.length && (this._$AR(i && i._$AB.nextSibling, a), r.length = a);
  }
  _$AR(t = this._$AA.nextSibling, r) {
    var i;
    for ((i = this._$AP) == null ? void 0 : i.call(this, !1, !0, r); t !== this._$AB; ) {
      const a = Ye(t).nextSibling;
      Ye(t).remove(), t = a;
    }
  }
  setConnected(t) {
...
class me {
  ...
  constructor(t, r, i, a, o) {
    this.type = 1, this._$AH = p, this._$AN = void 0, this.element = t, this.name = r, this._$AM = a, this.options = o, i.length > 2 || i[0] !== "" || i[1] !== "" ? (this._$AH = Array(i.length - 1).fill(new String()), this.strings = i) : this._$AH = p;
  }
  _$AI(t, r = this, i, a) {
    const o = this.strings;
    let n = !1;
    if (o === void 0) t = G(this, t, r, 0), n = !ie(t) || t !== this._$AH && t !== W, n && (this._$AH = t);
    else {
      const s = t;
      let c, d;
      for (t = o[0], c = 0; c < o.length - 1; c++) d = G(this, s[i + c], r, c), d === W && (d = this._$AH[c]), n || (n = !ie(d) || d !== this._$AH[c]), d === p ? t = p : t !== p && (t += (d ?? "") + o[c + 1]), this._$AH[c] = d;
    }
    n && !a && this.j(t);
  }
  j(t) {
...
class qt extends me {
  ...
  _$AI(t, r = this) {
    if ((t = G(this, t, r, 0) ?? p) === W) return;
    const i = this._$AH, a = t === p && i !== p || t.capture !== i.capture || t.once !== i.once || t.passive !== i.passive, o = t !== p && (i === p || a);
...
ve == null || ve(ae, se), (Q.litHtmlVersions ?? (Q.litHtmlVersions = [])).push("3.3.3");
const Kt = (e, t, r) => {
  const i = (r == null ? void 0 : r.renderBefore) ?? t;
  let a = i._$litPart$;
  if (a === void 0) {
    const o = (r == null ? void 0 : r.renderBefore) ?? null;
    i._$litPart$ = a = new se(t.insertBefore(re(), o), o, void 0, r ?? {});
  }
  return a._$AI(e), a;
};
/**
...
class U extends N {
  ...
  update(t) {
    const r = this.render();
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(t), this._$Do = Kt(r, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
    var t;
...
var ct;
U._$litElement$ = !0, U.finalized = !0, (ct = z.litElementHydrateSupport) == null || ct.call(z, { LitElement: U });
const ye = z.litElementPolyfillSupport;
ye == null || ye({ LitElement: U });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Zt = { attribute: !0, type: String, converter: he, reflect: !1, hasChanged: ze }, Qt = (e = Zt, t, r) => {
...
function Le(e) {
  return (t, r) => typeof r == "object" ? Qt(e, t, r) : ((i, a, o) => {
...
const hr = /* @__PURE__ */ new Set([
  ...
  "radio_split",
  "cover"
]), ft = 0.1, gt = 600, F = 2, Oe = [
  "toggle",
  "momentary",
  "radio",
  "cover_open",
  "cover_close"
], ur = /* @__PURE__ */ new Set(["radio", "cover_open", "cover_close"]);
function pe(e, t = F) {
  return te(e, ft, gt, t);
}
function _r(e, t) {
  const r = String(e || "").trim().toLowerCase();
  return Oe.includes(r) ? r : String(t || "").trim().toLowerCase() === "momentary" ? "momentary" : "toggle";
}
function Ee(e) {
  return x(e) > 1 ? [...Oe] : Oe.filter((t) => !ur.has(t));
}
function bt(e) {
  return hr.has(e);
}
function Ke(e, t) {
  return x(t) > 1 ? [...e] : e.filter((r) => !bt(r));
}
function Ae(e, t) {
  return x(t) === 1 && bt(e) ? "toggle" : e;
}
function Ce(e) {
  return Math.max(0, Math.floor(x(e) / 2));
}
function mr(e, t) {
...
function Ze(e, t, r) {
  const i = Math.round(typeof e == "number" ? e : Number(e)), a = x(r);
  return !Number.isFinite(i) || i < 1 || i > a ? Math.min(t, a) : i;
}
function Y(e, t = {}) {
  const r = x(t.gangCount ?? 4), i = t.slot ?? 0, a = t.defaultId ?? `cover_${i + 1}`, [o, n] = mr(i, r), s = e || {}, c = Ze(s.open_button, o, r);
  let d = Ze(s.close_button, n, r);
  d === c && (d = Array.from({ length: r }, (g, b) => b + 1).find((g) => g !== c) ?? Math.min(c + 1, r));
  const h = s.ha_entity_id ?? s.entity_id, u = typeof h == "string" && h.trim().startsWith("cover.") ? h.trim() : null;
  return {
...
function w(e) {
  const t = x((e == null ? void 0 : e.gang_count) ?? 4), r = Ce(t);
  let i = [];
  if (Array.isArray(e == null ? void 0 : e.covers) && e.covers.length ? i = e.covers.map(
    (o, n) => Y(o, { gangCount: t, defaultId: `cover_${n + 1}`, slot: n })
...
function fr(e) {
  ...
  t.gang_count = x(t.gang_count ?? 4);
  let r = String(t.mode || "toggle");
  r === "momentary_mix" && (r = "mixed"), t.mode = Ae(r, t.gang_count), typeof t.backlight_brightness != "number" || !Number.isFinite(t.backlight_brightness) ? t.backlight_brightness = 100 : t.backlight_brightness = Math.max(
    0,
    Math.min(100, Math.round(t.backlight_brightness))
  );
  const i = new Set(Ee(t.gang_count));
  t.buttons = [1, 2, 3, 4].map((s) => {
    var h;
    const c = (h = t.buttons) == null ? void 0 : h.find((u) => u.index === s);
    let d = _r(c == null ? void 0 : c.role, c == null ? void 0 : c.press_mode);
    return i.has(d) || (d = "toggle"), {
      ...
      role: d,
      pulse_time_s: pe(c == null ? void 0 : c.pulse_time_s, F),
  ...
  const a = Array.isArray(t.radio_groups) ? t.radio_groups : [], o = new Set(
    ...
    buttons: Array.isArray(s == null ? void 0 : s.buttons) ? s.buttons.map((d) => Number(d)).filter(
      (d, h, u) => d >= 1 && d <= t.gang_count && u.indexOf(d) === h && (t.mode !== "mixed" || o.has(d))
    ) : []
  }));
  for (; n.length < 2; )
    n.push({ id: `g${n.length + 1}`, buttons: [] });
  return t.radio_groups = n, t.covers = w(t), delete t.cover, t.selected_button != null && (t.selected_button < 1 || t.selected_button > t.gang_count) && (t.selected_button = null), t;
}
function X(e) {
  return fr(e);
}
...
function yr(e) {
  const { comments: t } = e, r = Qe(e.entryId, vr), i = {
    morning: t.morning,
    evening: t.evening,
    night: t.night
  }, a = (n) => {
    var s;
    return Qe((s = e.profileIds) == null ? void 0 : s[n], we[n].profile);
  }, o = [
    ...ke(t.header),
    ...ke(t.sync),
    ...ke(t.ids),
  ...
  }), o.push("actions:"), o.push("  - choose:"), we.forEach((n, s) => {
...
function et(e, t) {
  ...
  const a = Array.isArray(e.buttons) ? e.buttons : [], o = [1, 2, 3, 4].map((s) => {
    const c = a.find(
      (h) => k(h) && Number(h.index) === s
    );
    if (!k(c))
      return { index: s, name: `Button ${s}`, action: null };
    let d = null;
    return k(c.action) && typeof c.action.action == "string" && (d = {
      action: c.action.action,
      target: k(c.action.target) ? c.action.target : {},
      data: k(c.action.data) ? c.action.data : {}
    }), {
      index: s,
  ...
  if (e.backlight_brightness !== void 0 && e.backlight_brightness !== null) {
    const s = Number(e.backlight_brightness);
...
function kr(e) {
  ...
  const t = e.schema_version ?? K, r = Number(t);
  if (!Number.isInteger(r) || r < 1)
    return { ok: !1, error: "schema_version must be a positive integer" };
  if (r > K)
    return {
      ok: !1,
      error: `Unsupported schema_version ${r}; current is ${K}`
    };
  const i = wr(e.profiles);
  if (!i.ok)
    return i;
  let a = null;
...
function Or(e, t, r = "YOUR_CONFIG_ENTRY_ID") {
...
const Er = /^([A-Za-z_][\w.-]*)\s*:\s*(.*?)\s*$/;
function Ar(e) {
  return !e || /^[-+]?(\d+(\.\d*)?|\.\d+)([eE][-+]?\d+)?$/.test(e) || /^(true|false|null|yes|no|on|off)$/i.test(e) ? !0 : /[:#{}[\],&*!|>'"%@`]|\s/.test(e) || e !== e.trim();
}
function Cr(e) {
  return e == null ? "null" : typeof e == "boolean" || typeof e == "number" ? String(e) : typeof e == "string" ? Ar(e) ? JSON.stringify(e) : e : JSON.stringify(e);
}
function Pr(e) {
  if (!e || typeof e != "object" || Array.isArray(e))
    return "";
  const t = Object.keys(e);
  return t.length ? t.map((r) => `${r}: ${Cr(e[r])}`).join(`
`) : "";
}
function Rr(e) {
  const t = e.trim();
...
const xt = "conx-dynamic-panel-lang", $t = {}, wt = {
  ...
  "card.action_data_hint": "Optional service data fields (like Developer Tools → Actions → data:). One key: value per line, or a JSON object. Entity picker still sets target; use this for extra fields (name, value, run, …).",
...
run: true`,
  ...
  "info.actions_body": "Action is a Home Assistant service (domain.service). Entity sets the target. Action data (YAML) adds extra service data fields (name, value, run, …) without replacing the entity target.",
  ...
  "card.action_data_hint": "שדות data אופציונליים לשירות (כמו כלי המפתחים → פעולות → data:). שורה לכל מפתח: ערך, או אובייקט JSON. בחירת הישות עדיין מגדירה את target; כאן מוסיפים שדות נוספים (name, value, run וכו').",
  "card.action_data_placeholder": `name: day
value: Morning
run: true`,
  ...
  "info.actions_body": "פעולה היא שירות Home Assistant (דומיין.שירות). הישות מגדירה את היעד. נתוני פעולה (YAML) מוסיפים שדות data נוספים (name, value, run וכו') בלי להחליף את יעד הישות.",
  ...
  "card.action_data_hint": "Необязательные поля data службы (как Инструменты разработчика → Действия → data:). Одна строка key: value или JSON-объект. Выбор сущности по-прежнему задаёт target; здесь — доп. поля (name, value, run и т.д.).",
  "card.action_data_placeholder": `name: day
value: Morning
run: true`,
  ...
  "info.actions_body": "Action — служба Home Assistant (домен.служба). Entity задаёт цель. Данные действия (YAML) добавляют поля data (name, value, run, …), не заменяя цель сущности.",
...
function Fr(e) {
  ...
  $t.language = e;
  try {
    (r = (t = globalThis.localStorage) == null ? void 0 : t.setItem) == null || r.call(t, xt, e);
  } catch {
  }
}
function O(e, t) {
  const r = oe(e);
  return Nr[r][t] || wt[t] || t;
}
function kt(e) {
  return oe(e) === "he";
}
const St = "conx-dynamic-panel-operate", Ot = {};
function Hr() {
  var e, t;
  try {
    const r = (t = (e = globalThis.localStorage) == null ? void 0 : e.getItem) == null ? void 0 : t.call(e, St);
    if (r === "1")
      return !0;
    if (r === "0")
      return !1;
...
const Et = "conx-dynamic-panel-theme", Ur = {
  industrial: "ivory",
  glass: "ivory",
  glass_light: "ivory",
  light_soft: "ivory",
...
], Yr = new Set(De.map((e) => e.id));
function fe(e) {
  return e ? Yr.has(e) ? e : Ur[e] || "noir" : "noir";
}
function it() {
  var e, t;
  try {
    const r = (t = (e = globalThis.localStorage) == null ? void 0 : e.getItem) == null ? void 0 : t.call(e, Et);
    return r ? fe(r) : null;
  } catch {
  }
  return null;
...
function Wr(e) {
  var t, r;
  try {
    (r = (t = globalThis.localStorage) == null ? void 0 : t.setItem) == null || r.call(t, Et, e);
  } catch {
  }
}
function at(e, t) {
  return e ? fe(e) : t || "noir";
}
var Gr = Object.defineProperty, Ir = Object.getOwnPropertyDescriptor, m = (e, t, r, i) => {
  for (var a = i > 1 ? void 0 : i ? Ir(t, r) : t, o = e.length - 1, n; o >= 0; o--)
...
const D = [
  ...
  "warmwhite",
  "warmyellow"
]), At = "#00e5ff", Jr = "#00c8de", Ct = "conx-dynamic-panel-radio-groups-open";
function Xr() {
  var e, t;
  try {
    const r = (t = (e = globalThis.localStorage) == null ? void 0 : e.getItem) == null ? void 0 : t.call(e, Ct);
    if (r === "0")
      return !1;
    if (r === "1")
      return !0;
...
function qr(e) {
  var t, r;
  try {
    (r = (t = globalThis.localStorage) == null ? void 0 : t.setItem) == null || r.call(t, Ct, e ? "1" : "0");
  } catch {
  }
}
function _e(e) {
...
function H(e) {
  if (!e)
    return !1;
  const t = _e(e);
  return nt.has(t) ? !0 : nt.has(t.replace(/_/g, ""));
}
function j(e) {
  const t = _e(e);
...
function le(e, t = At) {
  if (!e)
    return t;
  const i = j(e).trim().toLowerCase().replace(/[\s-]+/g, "_");
  return ot[i] || ot[i.replace(/_/g, "")] || t;
}
function Kr(e, ...t) {
  const r = Vr(e), i = new Set(r.map((a) => _e(a)));
  for (const a of t) {
    const o = String(a || "").trim();
    if (!o)
      continue;
    const n = H(o) ? j(o) : o, s = _e(n);
...
function st(e, t) {
  const r = e.trim().toLowerCase().replace(/[\s-]+/g, "_"), i = O(t, `color.${r}`);
  return i !== `color.${r}` ? i : e;
}
function Qr(e, t) {
  const r = e.trim().toLowerCase().replace(/[\s-]+/g, "_"), i = O(t, `radar.${r}`);
...
let _ = class extends U {
  ...
  setConfig(e) {
    ...
    this._config = e, e.language && (this._uiLang = oe(e.language)), this._theme = at(e.theme, it());
  }
  connectedCallback() {
    var e;
    super.connectedCallback(), this._uiLang || (this._uiLang = Br() || void 0), this._theme = at((e = this._config) == null ? void 0 : e.theme, it()), this._operateMode = Hr(), this._operateMode && (this._previewOpen = !0), this._ensureFonts(), this._ensureRuntimeSubscription(), this._ensureHaEntityPicker();
  }
  _toggleOperateMode() {
    this._setOperateMode(!this._operateMode);
  }
  _setOperateMode(e) {
    this._operateMode = e, jr(this._operateMode), this._operateMode && (this._previewOpen = !0, this._menuOpen = !1, this._automationOpen = !1, this._infoOpen = !1, this._view === "export" && (this._view = "editor"));
  }
  _exitOperateMode() {
  ...
  _wizardIndex() {
    return D.indexOf(this._wizardStep);
  }
  _wizardNext() {
    const e = this._wizardIndex();
    e < D.length - 1 && this._goToStep(D[e + 1]);
  }
  _wizardBack() {
    const e = this._wizardIndex();
    e > 0 && this._goToStep(D[e - 1]);
  }
  _buildServiceYaml(e) {
    if (!this._panel || !this._config)
      return "";
    const t = e || Sr(this._panel.profiles, this._panel.active_profile_id);
    return Or(
      t,
      this._importMode,
  ...
  get _dirty() {
    return !gr(this._draft || null, this._saved || null);
  }
  _setLanguage(e) {
    this._uiLang = e, Fr(e);
  }
  _setTheme(e) {
    this._theme = fe(e), Wr(this._theme), this._config && (this._config = { ...this._config, theme: this._theme }, this.dispatchEvent(
  ...
  _ensureRadioGroups(e) {
    const t = Array.isArray(e.radio_groups) ? e.radio_groups : [], r = x(e.gang_count ?? 4), i = e.mode === "mixed" ? new Set(
      (e.buttons || []).filter(
      ...
      <div class="radio-groups-section ${t ? "open" : ""}">
        <div class="radio-groups-head">
          <div class="radio-groups-head-main">
            ...
            ${t ? p : l`<div class="radio-groups-summary">
  ...
  async _load() {
    ...
    if (!(!this.hass || !((e = this._config) != null && e.entry_id))) {
      ...
      try {
        const t = await Ve(this.hass, this._config.entry_id);
  ...
  _applyPanel(e) {
    ...
    this._saved = r ? X(r) : void 0, this._draft = r ? X(r) : void 0, this._migrateBrokenWarmLedDraftColors(), this._clearFaceplatePreview(), ((i = this._draft) == null ? void 0 : i.mode) === "radio_split" && (this._radioGroupsOpen = Xr() ?? !0), this._syncMomentaryFromRuntime(e.momentary_active);
  }
  ...
  _migrateBrokenWarmLedDraftColors() {
    if (!this._draft)
      return;
    let e = !1;
    H(this._draft.color_on) && (this._draft.color_on = j(this._draft.color_on), e = !0), H(this._draft.color_off) && (this._draft.color_off = j(this._draft.color_off), e = !0), e && this.requestUpdate();
  }
  ...
  async _ensureRuntimeSubscription() {
    ...
    if (!(!this.hass || !e || !this._panel) && !(this._unsubRuntime && this._runtimeEntryId === e)) {
      ...
      try {
        this._unsubRuntime = await pr(this.hass, e, (r) => {
  ...
  _armMomentaryUiPulse(e, t) {
    ...
    const r = (a = this._draft) == null ? void 0 : a.buttons.find((o) => o.index === e), i = pe(r == null ? void 0 : r.pulse_time_s, F) * 1e3;
  ...
  _gangCount(e) {
    var t;
    return x(((t = e || this._draft) == null ? void 0 : t.gang_count) ?? 4);
  }
  _gangIndexes(e) {
  ...
  _patchCovers(e) {
    this._patchDraft((t) => {
      const r = w(t);
      e(r, t), t.covers = w({ ...t, covers: r }), delete t.cover;
    });
  }
  _setGangCount(e) {
    this._patchDraft((t) => {
      t.gang_count = x(e), t.mode = Ae(t.mode, t.gang_count), t.covers = w(t), delete t.cover, t.radio_groups && (t.radio_groups = t.radio_groups.map((r) => ({
        ...r,
  ...
  _setMode(e) {
    ...
    !this._draft || !Ke(
      ...
      if (r.mode = e, r.mode === "cover") {
        ...
        r.gang_count = a < 4 ? 4 : a, r.covers = w(r), delete r.cover;
  ...
  _setButtonRole(e, t) {
    this._patchDraft((r) => {
      ...
      if (!(!i || !Ee(r.gang_count).includes(t))) {
        if (i.role = t, t === "momentary")
          ...
          i.cover_id = String(i.cover_id || "cover_1").trim() || "cover_1", r.covers = w(r);
  ...
  _setCoverTime(e, t, r) {
    const i = Math.max(
      B,
      Math.min(ee, Number.isFinite(r) ? r : B)
    );
    this._patchCovers((a) => {
  ...
  _renderCoverHaEntityPicker(e) {
    var n;
    const t = (e.ha_entity_id || "").trim(), r = this._haEntityPickerReady && !!this.hass, i = Se(
      rt((n = this.hass) == null ? void 0 : n.states, "cover"),
      t
  ...
  _renderInlineCoverTimeFields(e) {
    var o;
    const t = (o = this._panel) == null ? void 0 : o.capabilities.cover, r = (t == null ? void 0 : t.min_time_s) ?? B, i = (t == null ? void 0 : t.max_time_s) ?? ee, a = this.t("card.cover_seconds");
    return l`
      <label class="field">
      ...
      <label class="field">
        ...
        <input
          type="number"
          data-cover-settle
          min=${(t == null ? void 0 : t.min_settle_s) ?? q}
    ...
    return l`
      <div class="mixed-cover-extras" data-mixed-cover-extras>
        <div
          ...
          data-inline-cover-times=${n ? r.id : p}
        >
          ${o ? l`
      ...
      (d) => l`
          ...
          ${n ? this._renderInlineCoverTimeFields(r) : p}
        </div>
        ${s && c != null ? l`<p
  ...
  _renderOneCoverEditor(e, t) {
    var s;
    const r = (s = this._panel) == null ? void 0 : s.capabilities.cover, i = (r == null ? void 0 : r.min_time_s) ?? B, a = (r == null ? void 0 : r.max_time_s) ?? ee, o = this.t("card.cover_seconds"), n = this._covers().length > 1;
    return l`
      ...
      Number(c.target.value)
          ...
          <label class="field">
            ...
            <input
              type="number"
              data-cover-settle
              min=${(r == null ? void 0 : r.min_settle_s) ?? q}
      ...
      this._patchCovers((h) => {
        const u = h.find((g) => g.id === e.id);
        u && (u.direction_settle_s = Math.max(
          q,
          Math.min(
            V,
      ...
      this._patchCovers((h) => {
        const u = h.find((g) => g.id === e.id);
        u && (u.opposite_press = d === "stop_then_reverse" ? "stop_then_reverse" : "stop_only");
      });
    }}
            >
              <option value="stop_only">${this.t("cover.stop_only")}</option>
  ...
  _renderCoverEditor() {
    if (!this._draft || this._draft.mode !== "cover")
      return p;
    const e = this._covers(), t = Ce(this._gangCount()), r = Array.from(
  ...
  _renderCoverControl() {
    ...
    return l`
      ...
      const n = (h = (d = (c = this._panel) == null ? void 0 : c.cover_state) == null ? void 0 : d.covers) == null ? void 0 : h.find(
        (b) => b.id === o.id
      ), s = (n == null ? void 0 : n.state) || t.length === 1 && ((g = (u = this._panel) == null ? void 0 : u.cover_state) == null ? void 0 : g.state) || "idle";
      return l`
    ...
    if (!(!this.hass || !this._config || !this._draft)) {
      ...
      try {
        const e = await er(
          ...
          this._draft.id,
          this._draft
        ), t = await Ve(this.hass, this._config.entry_id);
  ...
  async _sync() {
    if (!(!this.hass || !this._config)) {
      ...
      try {
        const e = await ar(this.hass, this._config.entry_id);
        this._applyPanel(e);
      } catch (e) {
  ...
  async _pull() {
    if (!(!this.hass || !this._config) && await this._guardDirty()) {
      this._busy = !0, this._error = void 0;
      try {
        const e = await or(this.hass, this._config.entry_id);
        this._applyPanel(e);
      } catch (e) {
        this._error = e instanceof Error ? e.message : String(e);
      } finally {
  ...
  async _createProfile() {
    ...
    this._busy = !0;
    try {
      await tr(this.hass, this._config.entry_id, t);
      const r = await $e(
        this.hass,
        this._config.entry_id,
        e,
  ...
  async _deleteProfile() {
    if (!(!this.hass || !this._config || !this._draft || !this._panel)) {
      ...
      if (window.confirm(`${this.t("card.delete")} ${this._draft.name}?`)) {
        this._busy = !0;
        try {
          await rr(this.hass, this._config.entry_id, this._draft.id), await this._load();
        } catch (e) {
          this._error = e instanceof Error ? e.message : String(e);
        } finally {
          this._busy = !1;
  ...
  async _export() {
    if (!(!this.hass || !this._config || !this._panel)) {
      this._busy = !0, this._error = void 0;
      try {
        const e = await nr(this.hass, this._config.entry_id), t = this._panel.panel_name.replace(/[^\w.-]+/g, "_");
        br(`conx-profiles-${t}.json`, e), this._refreshServiceYaml(e), this._notice = this.t("card.export_ok");
      } catch (e) {
        this._error = e instanceof Error ? e.message : String(e);
      } finally {
        this._busy = !1;
  ...
  async _importFile(e, t) {
    if (!(!this.hass || !this._config) && await this._guardDirty()) {
      this._busy = !0, this._error = void 0;
      try {
        const r = await e.text(), i = kr(JSON.parse(r));
        if (!i.ok)
  ...
  async _ensureHaEntityPicker() {
    if (this._haPickerLoadStarted || (this._haPickerLoadStarted = !0, vt() && (this._haEntityPickerReady = !0), yt() && (this._haServicePickerReady = !0), this._haEntityPickerReady && this._haServicePickerReady))
      return;
    const e = await Tr();
    this._haEntityPickerReady = e.entity, this._haServicePickerReady = e.service;
  }
  _pickerFilterKey(e, t) {
    return `${e}:${t}`;
  }
  _getPickerFilter(e, t) {
    return this._pickerFilter[this._pickerFilterKey(e, t)] || "";
  }
  _setPickerFilter(e, t, r) {
    const i = this._pickerFilterKey(e, t), a = r.trim().toLowerCase();
    (this._pickerFilter[i] || "") !== a && (this._pickerFilter = { ...this._pickerFilter, [i]: a });
  }
  _filterOptions(e, t) {
    return t ? e.filter((r) => r.toLowerCase().includes(t)) : e;
  }
  _onHaServicePickerChanged(e, t) {
    t.stopPropagation();
    const r = t.detail, i = ((r == null ? void 0 : r.value) ?? "").trim();
    this._setButtonAction(e, i);
  }
  _setButtonAction(e, t, r) {
    const i = t.trim();
    this._patchDraft((a) => {
      var d, h, u;
      const o = a.buttons.find((g) => g.index === e);
      if (!o)
        return;
      if (!i) {
        o.action = null;
      ...
      const n = (h = (d = o.action) == null ? void 0 : d.target) == null ? void 0 : h.entity_id, s = tt(i);
      let c = r === void 0 ? (n == null ? void 0 : n.trim()) || "" : (r ?? "").trim();
      s && c && !c.startsWith(`${s}.`) && (c = ""), o.action = {
        action: i,
        target: c ? { entity_id: c } : {},
        data: ((u = o.action) == null ? void 0 : u.data) || {}
      };
    }), i || this._clearActionDataEditor(e);
  }
  ...
  _actionDataDisplay(e) {
    var r, i;
    if (Object.prototype.hasOwnProperty.call(this._actionDataText, e))
      return this._actionDataText[e];
    const t = (r = this._draft) == null ? void 0 : r.buttons.find((a) => a.index === e);
    return Pr(((i = t == null ? void 0 : t.action) == null ? void 0 : i.data) || {});
  }
  _toggleActionDataOpen(e) {
    this._actionDataOpen = {
      ...this._actionDataOpen,
      [e]: !this._actionDataOpen[e]
    };
  }
  _clearActionDataEditor(e) {
    if (!Object.prototype.hasOwnProperty.call(this._actionDataText, e) && !this._actionDataError[e])
      return;
    const t = { ...this._actionDataText }, r = { ...this._actionDataError };
    delete t[e], delete r[e], this._actionDataText = t, this._actionDataError = r;
  }
  _onActionDataInput(e, t) {
    const r = t.target.value;
    this._actionDataText = { ...this._actionDataText, [e]: r };
    const i = Mr(r);
    if (!i.ok) {
    ...
    delete a[e], this._actionDataError = a, this._patchDraft((o) => {
      var s;
      const n = o.buttons.find((c) => c.index === e);
      (s = n == null ? void 0 : n.action) != null && s.action && (n.action = {
        ...n.action,
        data: i.data
      });
    });
  ...
  _renderActionEntityPickers(e, t, r) {
    var C, P;
    const i = Se(
      zr((C = this.hass) == null ? void 0 : C.services),
      t
    ), a = tt(t), o = Se(
      rt((P = this.hass) == null ? void 0 : P.states, a),
      r
    ), n = this._haEntityPickerReady && !!this.hass, s = this._haServicePickerReady && !!this.hass, c = this._getPickerFilter("action", e), d = this._getPickerFilter("entity", e), h = this._filterOptions(i, c), u = this._filterOptions(o, d), g = !!this._actionDataOpen[e], b = this._actionDataDisplay(e), y = this._actionDataError[e] || "", A = !!t;
    return l`
      <label class="field">
        ...
        ${s ? l`
              <ha-service-picker
                ...
                .value=${t || ""}
                ?disabled=${this._busy}
                @value-changed=${(v) => this._onHaServicePickerChanged(e, v)}
              ></ha-service-picker>
            ` : l`
              <input
                type="search"
      ...
      v.target.value
              ...
              <div class="select-wrap select-wrap-wide">
                <select
                  ...
                  .value=${t}
                  ?disabled=${this._busy}
                  @change=${(v) => this._onButtonActionSelect(e, v)}
                >
      ...
      <label class="field">
        ...
        ${n ? l`
              <ha-entity-picker
                ...
                @value-changed=${(v) => this._onHaEntityPickerChanged(e, v)}
              ></ha-entity-picker>
            ` : l`
              <input
                type="search"
      ...
      v.target.value
              ...
              <div class="select-wrap select-wrap-wide">
                <select
                  ...
                  .value=${r}
                  ?disabled=${this._busy || !t}
                  @change=${(v) => this._onButtonEntitySelect(e, v)}
                >
      ...
      <div class="action-data-field" data-action-data-field data-button=${e}>
        <button
          type="button"
          ...
          @click=${() => this._toggleActionDataOpen(e)}
        >
        ...
        ${g ? l`
              <label class="field action-data-editor">
                <textarea
                  ...
                  .value=${b}
                  ?disabled=${this._busy || !A}
                  @input=${(v) => this._onActionDataInput(e, v)}
                ></textarea>
                <span class="field-hint">${this.t("card.action_data_hint")}</span>
                ${y ? l`<span class="field-error" data-action-data-error
                      >${this.t("card.action_data_invalid")}: ${y}</span
                    >` : p}
              </label>
            ` : p}
      </div>
  ...
  _isRingOn(e) {
    ...
    if (o) {
      if (t !== null)
        return t;
      const h = this._coverForButton(e), u = (s = this._panel) == null ? void 0 : s.cover_state;
      if (u != null && u.active && h) {
        const g = (c = u.covers) == null ? void 0 : c.find((b) => b.id === h.id);
        return g ? g.direction === o : u.cover_id === h.id || !((d = u.covers) != null && d.length) ? u.direction === o : !1;
      }
      return r ? i : !1;
    }
  ...
  async _dispatchButtonPress(e) {
    ...
    if (!(!this.hass || !t || this._busy))
      try {
        const i = await dr(this.hass, t, e);
  ...
  _ringOnColor() {
    var e;
    return le((e = this._draft) == null ? void 0 : e.color_on, At);
  }
  _ringOffColor() {
    var e;
    return le((e = this._draft) == null ? void 0 : e.color_off, Jr);
  }
  _renderFlag(e) {
    return e === "IL" ? l`
    ...
    return l`
      <div class="wizard-footer">
        ...
        <button
          type="button"
          class="btn primary"
          ?disabled=${this._busy || e >= D.length - 1}
  ...
  _renderAppearanceFields() {
    ...
    ), t = H(this._draft.color_on) ? j(this._draft.color_on) : this._draft.color_on, r = H(this._draft.color_off) ? j(this._draft.color_off) : this._draft.color_off, i = Zr(
  ...
  _renderMixedRolesSection() {
    if (!this._draft || this._draft.mode !== "mixed")
      return p;
    const e = Ee(this._gangCount()), t = this._covers(), r = t.length > 1, i = this._draft.buttons.filter(
    ...
    return l`
      <div class="mixed-roles-section" data-mixed-roles>
        ...
        ${i.map((a) => {
      var v, L, ce, I;
      const o = a.role || "toggle", n = a.pulse_time_s ?? F, s = String(a.cover_id || ((v = t[0]) == null ? void 0 : v.id) || "cover_1").trim() || "cover_1", c = (a.name || "").trim() || "—", d = o === "cover_open" || o === "cover_close", h = o === "toggle" || o === "momentary" || o === "radio", u = h || d, g = t.find(($) => $.id === s) || t[0], b = d ? this._firstCoverRoleIndex(s) : null, y = d && g && b === a.index, A = d && g && b != null && b !== a.index, C = String(
        ((ce = (L = a.action) == null ? void 0 : L.target) == null ? void 0 : ce.entity_id) || ""
      ), P = ((I = a.action) == null ? void 0 : I.action) || "";
      return l`
        ...
        this._patchDraft((Rt) => {
          const Be = Rt.buttons.find(
            (Mt) => Mt.index === a.index
          );
          Be && (Be.pulse_time_s = pe(
            Pt,
            F
          ));
        });
        ...
        C
                          ...
                          ` : p}
                      ${d && g ? this._renderMixedCoverExtras({
        buttonIndex: a.index,
        cover: g,
        coverId: s,
        covers: t,
  ...
  _renderButtonsFields() {
    return !this._panel || !this._draft ? p : l`
      ...
      ), i = (e.name || "").trim() || "—", a = ((A = e.action) == null ? void 0 : A.action) || "", o = ((C = this._draft) == null ? void 0 : C.mode) === "radio_mandatory" || ((P = this._draft) == null ? void 0 : P.mode) === "radio_optional", n = e.radio_member !== !1, s = this._coverDirectionFor(e.index), c = ((v = this._draft) == null ? void 0 : v.mode) === "mixed" ? e.role || "toggle" : null, d = c === "cover_open" || c === "cover_close", h = c ? this.t(`role.${c}`) : s ? this.t(
        s === "open" ? "card.cover_open" : "card.cover_close"
      ) : o ? n ? this.t("card.radio_member") : this.t("card.radio_toggle") : "", u = !d && !a, g = [
        d ? "" : a,
        d ? "" : r,
        h,
        u ? this.t("card.missing_action") : ""
      ].filter(Boolean).join(" · ") || "—";
      return l`
                <div
                ...
                >
                  ...
                  >
                    ...
                    <span class="button-edit-summary">
                      ...
                      <span class="button-edit-meta">${g}</span>
                    </span>
                  </button>
                      ...
                      ${t ? l`
                            <label class="field">
                              ...
                              <input
                                ...
                                .value=${e.name}
                                ?disabled=${this._busy}
                                @input=${(L) => this._onButtonNameInput(e.index, L)}
                              />
                            </label>
                            ${d ? p : l`
                                  ${u ? l`<p
                                  ...
                                  <label class="field">
                                    ...
                                    <div class="select-wrap">
                                      <select
                                        ...
                                        ?disabled=${this._busy}
                                        @change=${(L) => this._patchDraft((ce) => {
        const I = ce.buttons.find(
          ($) => $.index === e.index
        );
        I && (I.radio_member = L.target.value === "radio");
      })}
                                      >
                                        <option value="radio">
  ...
  render() {
    ...
    const t = !!this._config.compact, r = this._operateMode, i = this._menuOpen || this._automationOpen || this._infoOpen || this._view === "export";
    return l`
      <ha-card
        dir=${e ? "rtl" : "ltr"}
        data-theme=${this._theme}
        data-operate=${r ? "true" : "false"}
        class="conx-card theme-${this._theme} ${this._view === "export" ? "export-open" : "editor-open"} ${this._menuOpen ? "menu-open" : ""} ${i ? "overlay-open" : ""} ${t ? "compact" : ""} ${r ? "operate-mode" : ""} ${this._syncPulse ? "syncing-pulse" : ""}"
      >
      ...
      this._menuOpen = !this._menuOpen;
        ...
        ${this._infoOpen ? this._renderInfoGuide() : p}
...
m([
  f()
], _.prototype, "_haServicePickerReady", 2);
m([
  f()
], _.prototype, "_pickerFilter", 2);
m([
  f()
], _.prototype, "_actionDataOpen", 2);
m([
  f()
], _.prototype, "_actionDataText", 2);
m([
  f()
], _.prototype, "_actionDataError", 2);
_ = m([
  mt("conx-dynamic-panel-card")
], _);
var ei = Object.defineProperty, ti = Object.getOwnPropertyDescriptor, Ne = (e, t, r, i) => {
  for (var a = i > 1 ? void 0 : i ? ti(t, r) : t, o = e.length - 1, n; o >= 0; o--)
    (n = e[o]) && (a = (i ? n(t, r, a) : n(a)) || a);
  ...
  render() {
    ...
    return l`
      <div class="editor" dir=${e ? "rtl" : "ltr"}>
        <label>
          ${O(this._language, "editor.entry_id")}
          <input
      ...
      entry_id: t.target.value.trim()
        ...
        <label>
          ${O(this._language, "card.language")}
          <select
      ...
      (t) => l`<option value=${t.id}>${t.label}</option>`
        ...
        <label>
          ${O(this._language, "card.theme")}
          <select
            .value=${fe(this._config.theme)}
            @change=${(t) => this._valueChanged({
...
ne = Ne([
  mt("conx-dynamic-panel-card-editor")
], ne);
